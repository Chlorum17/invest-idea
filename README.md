...
3. [Информация для тестирования](#информация-для-тестирования)
   3.1. [Содержимое .env](#содержимое-.env)
...
3. Создать в корне проекта .env файл со [следующим содержимым](#содержимое-.env)
...
Эндпоинт для добавления данных, если потребуется **PATCH** http://localhost:8080/api/invest-ideas/update/:ideaId
